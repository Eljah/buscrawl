...
run_transfer_origin() {
  ...
  env \
    ...
    BUS_TRANSFER_FLUSH_EVERY_BUCKET="${BUS_TRANSFER_FLUSH_EVERY_BUCKET:-false}" \
    BUS_TRANSFER_WRITE_BATCH_ROWS="${BUS_TRANSFER_WRITE_BATCH_ROWS:-250000}" \
    BUS_TRANSFER_POTENTIAL_OUTPUT_PARTITIONS="${BUS_TRANSFER_POTENTIAL_OUTPUT_PARTITIONS:-4}" \

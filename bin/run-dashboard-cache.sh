...
export BUS_TRANSFER_POTENTIAL_ORIGIN_ROOT=${BUS_TRANSFER_POTENTIAL_ORIGIN_ROOT:-/home/eljah/data/buscrawl/transfer-potential-accessibility-origins}
...
export BUS_DASHBOARD_DERIVED_SERIES_ENABLED=${BUS_DASHBOARD_DERIVED_SERIES_ENABLED:-false}
export BUS_DASHBOARD_TRANSFER_SERIES_ENABLED=${BUS_DASHBOARD_TRANSFER_SERIES_ENABLED:-false}

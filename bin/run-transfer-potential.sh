...
export BUS_TRANSFER_MAX_CANDIDATE_EVENTS_PER_STOP=${BUS_TRANSFER_MAX_CANDIDATE_EVENTS_PER_STOP:-1}
export BUS_TRANSFER_MAX_BUCKETS_PER_RUN=${BUS_TRANSFER_MAX_BUCKETS_PER_RUN:-100000}
export BUS_TRANSFER_STOP_BEFORE_LOCAL_TIME=${BUS_TRANSFER_STOP_BEFORE_LOCAL_TIME:-03:55}

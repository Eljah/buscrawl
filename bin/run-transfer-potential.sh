...
export BUS_TRANSFER_PROFILE_FLAG_FILE=${BUS_TRANSFER_PROFILE_FLAG_FILE:-/home/eljah/data/buscrawl/transfer-profile.enabled}
if [ -z "${BUS_TRANSFER_PROFILE+x}" ]; then
  if [ -f "$BUS_TRANSFER_PROFILE_FLAG_FILE" ]; then
    export BUS_TRANSFER_PROFILE=true
  else
    export BUS_TRANSFER_PROFILE=false
  fi
else
  export BUS_TRANSFER_PROFILE
fi

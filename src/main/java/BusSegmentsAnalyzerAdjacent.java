...
public class BusSegmentsAnalyzerAdjacent {
    ...
    public static void main(String[] args) throws Exception {
        SparkSession spark = SparkSession.builder()
                .appName("BusSegmentsAnalyzerAdjacent")
                .master("local[*]")
        ...
        if (Files.exists(Paths.get("D:/parquet/speedStats_adj.parquet"))) {
            speedStats = spark.read().parquet("D:/parquet/speedStats_adj.parquet");
        } else {
            ...
            speedStats.write().mode("overwrite").parquet("D:/parquet/speedStats_adj.parquet");
        }

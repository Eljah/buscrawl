...
public class CheckTmpRN {
 ...
 String base="/home/eljah/data/buscrawl/tmp-transfer-route-network/journeys/serviceDate=2026-06-21/departureBucketMinute=480/*.parquet";
 ...
 String q="select originStopId,destinationStopId,destinationStopName,totalJourneySeconds,routePattern from read_parquet('"+base+"') where originStopId in ('12078','12112') and (destinationStopName like '%Привокз%' or destinationStopName like '%Мосто%' or destinationStopName like '%Дербыш%' or destinationStopName like '%Речн%') order by totalJourneySeconds limit 30";

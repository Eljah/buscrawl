...
print('\nMATCHED STOPS')
for s in stops:
    if any(x in s['name'] for x in ['пл. Восстания','Волгоградская','Ибрагимова','Восстания (Ибрагимова)','Урицкого','Адмиралтейская']):
